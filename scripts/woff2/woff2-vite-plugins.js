  ...
  return {
    ...
    transform(code, id) {
      ...
      @font-face {
        ...
        src: url(./Assistant/Assistant-Regular.woff2)
          format("woff2");
        font-weight: 400;
        style: normal;
        display: swap;
      ...
      @font-face {
        font-family: "Assistant";
        src: url(./Assistant/Assistant-Medium.woff2)
          format("woff2");
        font-weight: 500;
        style: normal;
        display: swap;
      ...
      @font-face {
        font-family: "Assistant";
        src: url(./Assistant/Assistant-SemiBold.woff2)
          format("woff2");
        font-weight: 600;
        style: normal;
        display: swap;
      ...
      @font-face {
        font-family: "Assistant";
        src: url(./Assistant/Assistant-Bold.woff2)
          format("woff2");
        font-weight: 700;
        style: normal;
        display: swap;
      ...
      <link
        rel="preload"
        href="${LOCAL_FONTS_BASE}Excalifont/Excalifont-Regular-a88b72a24fb54c9f94e3b5fdaa7481c9.woff2"
        as="font"
        type="font/woff2"
      ...
      <link
        rel="preload"
        href="${LOCAL_FONTS_BASE}Nunito/Nunito-Regular-XRXI3I6Li01BKofiOc5wtlZ2di8HDIkhdTQ3j6zbXWjgeg.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
      <link
        rel="preload"
        href="${LOCAL_FONTS_BASE}Assistant/Assistant-SemiBold.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
      <link
        rel="preload"
        href="${LOCAL_FONTS_BASE}ComicShanns/ComicShanns-Regular-279a7b317d12eb88de06167bd672b4b4.woff2"
        as="font"
        type="font/woff2"
        crossorigin="anonymous"
      />
